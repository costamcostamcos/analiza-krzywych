...
# FIX: POPRAWIONA NAZWA FUNKCJI (USUNIĘTE CHIŃSKIE ZNAKI SPECJALNE)
...
if df is not None:
    try:
        ...
        with col_sidebar:
            ...
            if cache_key not in st.session_state:
                if df_expert_raw is not None and len(df_expert_raw) > 0:
                    ...
                    # POPRAWKA MAPOWANIA: Absolutne czyszczenie tekstu i spacji (y1 == y1)
                    expert_mapping = {}
        ...
        with col_main:
            ...
            # FIX: WYWOŁANIE FUNKCJI Z POPRAWNĄ NAZWĄ
